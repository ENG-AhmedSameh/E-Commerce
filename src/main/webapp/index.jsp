					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="${pageContext.request.contextPath}/front?page=shop"
		...
		<div class="flex-w flex-c-m">
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					...
					<a href="${pageContext.request.contextPath}/front?page=shop&category=1"
			...
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					...
					<a href="${pageContext.request.contextPath}/front?page=shop&category=2"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							<span class="block1-name ltext-102 trans-04 p-b-8">
								Laptop & Pc
			...
			<div class="size-202 m-lr-auto respon4">
				...
				<div class="block1 wrap-pic-w">
					...
					<a href="${pageContext.request.contextPath}/front?page=shop&category=3"
						class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
						<div class="block1-txt-child1 flex-col-l">
							<span class="block1-name ltext-102 trans-04 p-b-8">
								Accessories
