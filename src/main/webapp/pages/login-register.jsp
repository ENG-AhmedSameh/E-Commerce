                                                                ...
                                                                <%-- <label class="login-toggle-btn center-content">--%>
                                                                    <%-- <a href="#">Forgot Password?</a>--%>
                                                                        <%-- </label>--%>
                                                                            <%-- </div>--%>
                                                                                <div
                                                                                    class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-03 text-center" 
                                                                                    >
                                                                                    <button
                                                                                        type="submit" class="vero" style="background-color: rgb(111, 109, 253);">Login</button>
                                                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="form-container">
                                        <form id="registrationForm" action="front?page=registration" method="post">
                                            ...
                                            <div class="line d-flex ">
                                                <input class="form-controll w-50 mr-2" type="text" id="first_name"
                                                    name="firstname" placeholder="First Name" required>
                                                <input class="form-controll w-50 ml-2" type="text" id="last_name"
                                                    name="lastname" placeholder="Last Name" required>
                                            </div>

                                            <div class="line d-flex">
                                                <input class="form-controll w-75 " type="text" class="line-custom"
                                                    id="user_name" name="username" onblur="posUserNametData();"
                                            ...
                                            <div class="line d-flex">
                                                <input class="form-controll w-75 " type="email" class="line-custom"
                                                    id="user_email" name="email" placeholder="Email"
                                                    onblur="postEmailData();" required>

                                                <span class="m-2" id="emailError" class="error"></span>
                                            </div>

                                            <div class="line d-flex">
                                                <input class="form-controll w-50 mr-2" type="text" id="City" name="city"
                                                    placeholder="City" required>
                                                <input class="form-controll w-50 ml-2" type="text" id="Street"
                                            ...
                                            <div class="block-input line d-flex">
                                                <input class="form-controll w-50 mr-2" type="tel" id="phone_number"
                                                    name="phoneNumber" placeholder="Phone Number ex: 012xxx" required>
                                                <input class="form-controll w-50 ml-2" type="text" id="job" name="job"
                                                    placeholder="Job">
                                            </div>
                                            <label id="PhoneM"></label>

                                            <input class="d-flex w-60" type="text" id="creditLimit" name="creditLimit"
                                                placeholder="Credit Limit" required maxlength="16">

                                            <div class="line d-flex">
                                                <input class="form-controll w-50 mr-2 " type="password" id="Password"
                                                    name="password" placeholder="Password" required>
                                                <input class="form-controll w-50 ml-2" type="password"
                                                    id="confirmPassword" name="confirmPassword"
                                                    placeholder="Confirm Password" required>
                                            
                                            </div>
                                            <label id="PWordM"></label>
