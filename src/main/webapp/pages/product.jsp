...
<body class="animsition">
	...
	<div class="filter-col2 p-r-15 p-b-27">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				<button  class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" onclick="fetchAndDisplayProducts();">
					Load More
				</button>
			</div>
		</div>
...
<%--	</script>--%>
	...
	<script>
		...
		function fetchAndDisplayProducts() {
			fetch(`front?page=shopMoreProductsGetter&pNum=${currentPage}`)
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${product.category.name}" data-price="${product.price}">
                        <div class="block2">
                            <div class="block2-pic hov-img0" style="width: 100%; height: 200px; overflow: hidden;">
                                ...
                                <a href="front?page=productDetails&id=${product.id}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" style="cursor:pointer;">
                                    Overview
                                </a>
                            </div>
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="front?page=productDetails&id=${product.id}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" style="cursor:pointer;">
                                        ${product.name}
                                    </a>
                                    <span class="stext-105 cl3">
                                        ${product.price} EGP
							...
							document.getElementById('product').insertAdjacentHTML('beforeend', productHtml);
							currentPage++;
						});
					})
